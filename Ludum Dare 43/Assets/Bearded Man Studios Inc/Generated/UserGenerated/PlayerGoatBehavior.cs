...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class PlayerGoatBehavior : NetworkBehavior
	{
		...
		public PlayerGoatNetworkObject networkObject = null;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (PlayerGoatNetworkObject)obj;
		...
		{
			Initialize(new PlayerGoatNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new PlayerGoatNetworkObject(networker, this, createCode, metadata);
		}
