			...
			MainThreadManager.Run(() =>
			{
				switch (identity)
				{
					...
					case CubeForgeGameNetworkObject.IDENTITY:
						...
						break;
					case DropZoneNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new DropZoneNetworkObject(networker, id, frame);
						break;
					...
					case PlayerNetworkObject.IDENTITY:
						...
						break;
					case ServerSideNetworkObject.IDENTITY:
						availableCallback = true;
						obj = new ServerSideNetworkObject(networker, id, frame);
						break;
